      ...
      <div className="grid grid-cols-12 w-full">
        ...
        <div className="hidden lg:flex lg:col-span-3 items-center justify-end gap-1 mx-2">
          ...
          <a
            ...
            className="ml-2 text-sm shadow rounded bg-[color:var(--ifm-menu-color)] px-2.5 py-1.5 text-white font-semibold opacity-75 focus:opacity-100 focus:outline-none hover:opacity-100 hover:text-white hover:no-underline flex items-center"
            aria-label="Twitter"
            rel="noreferrer"
          >
            Sign-in <svg
